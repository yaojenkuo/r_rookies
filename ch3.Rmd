...
num_vector[-1]
# 練習使用 `length()` 函數
lenght_of_num_vector <- length(num_vector)
lenght_of_num_vector
num_vector[2:lenght_of_num_vector]
```
...
- [基本資料結構 - 隨堂練習](https://yaojenkuo.github.io/r_rookies/ch3_exercise)
